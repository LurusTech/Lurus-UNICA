// Package crypto provides AES-256-GCM encryption helpers shared across
// unica services. The format matches admin/internal/crypto byte-for-byte
// so ciphertext produced by one service can be decrypted by another.
package crypto
